...
@section('content')
@php
    $asal = request('asal', 'Sijunjung');
    $tujuan = request('tujuan', 'Padang');
...
<div class="py-8 bg-slate-50 md:py-12">
    <div class="px-4 mx-auto max-w-5xl sm:px-6 lg:px-8">
        ...
        <form action="/booking/jadwal" method="GET" class="bg-slate-900 text-white rounded-2xl p-5 md:p-6 mb-8 shadow-md border border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-800 w-full md:w-auto flex-grow">
                ...
                <div class="flex flex-col sm:pl-4 pt-2 sm:pt-0">
                    ...
                    <span class="text-sm font-extrabold text-gold-400 py-0.5">Rp 70.000</span>
                </div>
            </div>
        ...
        <div class="space-y-6">
            ...
            <!-- Fleet Card 1: Toyota Avanza (CBF Recommended) -->
            <div class="group relative bg-white hover:bg-slate-50/20 rounded-2xl border border-slate-200/80 p-5 md:p-6 transition-all duration-300 hover:shadow-card hover:border-gold-500/30 flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="space-y-2">
                        <div class="flex flex-wrap items-center gap-2">
                            <h3 class="text-base md:text-lg font-bold text-slate-900">Armada : Toyota Avanza</h3>
                            ...
                            <span class="inline-flex items-center gap-1 px-2.5 py-0.5 text-[10px] font-extrabold text-gold-700 bg-gold-50 border border-gold-200/50 rounded-full select-none cursor-help relative group/tooltip shadow-[0_1px_4px_rgba(245,158,11,0.08)]">
                                ...
                                <!-- Tooltip explaining the matching logic -->
                                <span class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover/tooltip:block w-48 p-2 text-[10px] font-medium text-white bg-slate-950 rounded-lg text-center leading-normal shadow-md z-30 pointer-events-none">
                                    Cocok dengan histori perjalanan Anda pada pukul 05:00 WIB dan preferensi armada Avanza.
                                </span>
                            </span>
                        </div>
                        ...
                        <div class="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-slate-500">
                            ...
                            <span class="flex items-center gap-1.5">
                                ...
                                Kursi Tersedia : <strong class="text-slate-800 font-bold">4</strong>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center md:flex-col md:items-end justify-between md:justify-center border-t md:border-t-0 border-slate-200/60 pt-4 md:pt-0 gap-3">
                    <div class="text-left md:text-right">
                        ...
                        <span class="text-base font-extrabold text-gold-600">Rp 70.000</span>
                    </div>
                    <a href="/booking/pilih-kursi" class="px-5 py-2.5 text-xs font-bold text-white bg-slate-900 hover:bg-slate-950 border border-gold-500/20 hover:border-gold-500/50 rounded-xl shadow-xs transition-colors cursor-pointer text-center">
                        Pilih Jadwal
                    </a>
                </div>
            </div>

            <!-- Fleet Card 2: Toyota Calya -->
            <div class="group relative bg-white hover:bg-slate-50/20 rounded-2xl border border-slate-200/80 p-5 md:p-6 transition-all duration-300 hover:shadow-card hover:border-gold-500/30 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div class="flex items-start gap-4">
                    <div class="mt-1 flex items-center justify-center w-12 h-12 rounded-xl bg-slate-100 text-slate-700 shrink-0">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-2">
                        <h3 class="text-base md:text-lg font-bold text-slate-900">Armada : Toyota Calya</h3>
                        ...
                        <div class="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-slate-500">
                            ...
                            <span class="flex items-center gap-1.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-status-success"></span>
                                Kursi Tersedia : <strong class="text-slate-800 font-bold">3</strong>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="group relative bg-white hover:bg-slate-50/20 rounded-2xl border border-slate-200/80 p-5 md:p-6 transition-all duration-300 hover:shadow-card hover:border-gold-500/30 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div class="flex items-start gap-4">
                    ...
                    <div class="space-y-2">
                        <h3 class="text-base md:text-lg font-bold text-slate-900">Armada : Daihatsu Sigra</h3>
                        ...
                        <div class="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-slate-500">
                            ...
                            <span class="flex items-center gap-1.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-status-success"></span>
                                Kursi Tersedia : <strong class="text-slate-800 font-bold">5</strong>
                            </span>
                        </div>
                    </div>
                </div>
