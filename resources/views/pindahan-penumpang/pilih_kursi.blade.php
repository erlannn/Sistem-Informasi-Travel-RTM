...
<div class="py-8 bg-slate-50 md:py-12">
    <div class="px-4 mx-auto max-w-5xl sm:px-6 lg:px-8">
        ...
        <!-- Header Workflow Stepper (UX Correction: Sleek visual stepper tracking checkout progress) -->
        ...
        <form action="/booking/konfirmasi" method="GET" id="seat-selection-form">
            <!-- Hidden input to store selected seat number -->
            <input type="hidden" name="kursi" id="selected-seat-input" value="">
            
            <!-- Trip Meta Inputs for demo flow propagation -->
            <input type="hidden" name="asal" value="Sijunjung">
            <input type="hidden" name="tujuan" value="Padang">
            <input type="hidden" name="tanggal" value="20 Juli 2026">
            <input type="hidden" name="jam" value="05.00 WIB">
            <input type="hidden" name="armada" value="Toyota Avanza">
                    ...
                    <div class="bg-white rounded-2xl shadow-card border border-slate-100 p-6 transition-all">
                        ...
                        <div class="space-y-4">
                            <div class="flex justify-between items-center text-sm">
                                ...
                                <span class="font-bold text-slate-800">Sijunjung</span>
                            </div>
                            <div class="flex justify-between items-center text-sm">
                                <span class="text-slate-400 font-medium">Kota Tujuan</span>
                                <span class="font-bold text-slate-800">Padang</span>
                            </div>
                            <div class="flex justify-between items-center text-sm">
                                <span class="text-slate-400 font-medium">Tanggal Perjalanan</span>
                                <span class="font-bold text-slate-800">20 Juli 2026</span>
                            </div>
                            <div class="flex justify-between items-center text-sm">
                                <span class="text-slate-400 font-medium">Jam Keberangkatan</span>
                                <span class="font-bold text-slate-800">05.00 WIB</span>
                            </div>
                            <div class="flex justify-between items-center text-sm">
                                <span class="text-slate-400 font-medium">Armada</span>
                                <span class="font-bold text-slate-800">Toyota Avanza</span>
                            </div>
                            
                            <!-- Dynamically Display Selected Seat (UX Correction: Visual anchor for selected seat item) -->
                ...
                <div class="md:col-span-7">
                    <div class="bg-white rounded-2xl shadow-card border border-slate-100 p-6 transition-all">
                        <h2 class="text-base font-bold text-slate-900 pb-4 mb-6 border-b border-slate-100 flex items-center gap-2">
                            ...
                            Denah Kursi (Layout Toyota Avanza)
                        </h2>
                        ...
                        <div class="relative max-w-[280px] mx-auto bg-slate-50 border-2 border-slate-200 rounded-3xl p-6 shadow-inner">
                            ...
                            <!-- Front Cabin Indicator (Dashboard & Steering Wheel mockup) -->
                            ...
                            <!-- Seats Grid Map (Avanza Seat Structure) -->
                            <div class="grid grid-cols-3 gap-y-6 gap-x-4 items-center justify-center">
                                
                                <!-- Seat 1 (Row 1 left, next to driver) -->
                                <button type="button" data-seat="1" class="seat-btn py-3 text-sm font-bold text-slate-600 bg-white border-2 border-slate-200 rounded-xl shadow-xs transition-all hover:border-slate-300 focus:outline-none cursor-pointer flex items-center justify-center">
                                    1
                                </button>
                                
                                <!-- Walk Aisle (Row 1 Middle empty) -->
                                <div></div>
                                
                                <!-- Driver Seat Location (Row 1 Right placeholder - unclickable) -->
                                <div class="py-3 text-xs font-semibold text-slate-400 bg-slate-200/50 border border-slate-200 rounded-xl flex items-center justify-center select-none">
                                    Sopir
                                </div>

                                <!-- Seat 2 (Row 2 Left) -->
                                <button type="button" data-seat="2" class="seat-btn py-3 text-sm font-bold text-slate-600 bg-white border-2 border-slate-200 rounded-xl shadow-xs transition-all hover:border-slate-300 focus:outline-none cursor-pointer flex items-center justify-center">
                                    2
                                </button>

                                <!-- Seat 3 (Row 2 Middle - OCCUPIED in mockup) -->
                                ...
                                <!-- Seat 4 (Row 2 Right) -->
                                <button type="button" data-seat="4" class="seat-btn py-3 text-sm font-bold text-slate-600 bg-white border-2 border-slate-200 rounded-xl shadow-xs transition-all hover:border-slate-300 focus:outline-none cursor-pointer flex items-center justify-center">
                                    4
                                </button>

                                <!-- Seat 5 (Row 3 Left) -->
                                <button type="button" data-seat="5" class="seat-btn py-3 text-sm font-bold text-slate-600 bg-white border-2 border-slate-200 rounded-xl shadow-xs transition-all hover:border-slate-300 focus:outline-none cursor-pointer flex items-center justify-center">
                                    5
                                </button>

                                <!-- Seat 6 (Row 3 Middle) -->
                                <button type="button" data-seat="6" class="seat-btn py-3 text-sm font-bold text-slate-600 bg-white border-2 border-slate-200 rounded-xl shadow-xs transition-all hover:border-slate-300 focus:outline-none cursor-pointer flex items-center justify-center">
                                    6
                                </button>

                                <!-- Seat 7 (Row 3 Right) -->
                                <button type="button" data-seat="7" class="seat-btn py-3 text-sm font-bold text-slate-600 bg-white border-2 border-slate-200 rounded-xl shadow-xs transition-all hover:border-slate-300 focus:outline-none cursor-pointer flex items-center justify-center">
                                    7
                                </button>
            ...
            <!-- Form Submit Buttons (Primary CTA centered bottom) -->
            <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="/booking/jadwal" class="w-full sm:w-auto px-6 py-3 text-sm font-semibold text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors text-center cursor-pointer">
                    Kembali ke Jadwal
                </a>
...
<!-- Inline Javascript to support click selection states (Clean Vanilla UX) -->
<script>
        ...
        seatButtons.forEach(btn => {
            btn.addEventListener('click', function () {
                ...
                if (this.classList.contains('bg-gold-400')) {
                    ...
                    // Highlight currently selected seat
