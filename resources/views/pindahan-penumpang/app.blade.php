    ...
    <header class="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200/60 shadow-sm relative">
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center">
                    <a href="/" class="group focus:outline-none flex">
                ...
                <nav class="hidden md:flex items-center space-x-1">
                    <a href="/" class="px-4 py-2 text-xs lg:text-sm font-semibold rounded-xl transition-all {{ Request::is('/') ? 'text-brand-600 bg-brand-50/80 border border-brand-100 shadow-[0_2px_8px_rgba(37,99,235,0.06)]' : 'text-slate-600 hover:text-brand-600 hover:bg-slate-50/80' }}">
                        Beranda
                    </a>
                    
                    <a href="/booking/jadwal" class="px-4 py-2 text-xs lg:text-sm font-semibold rounded-xl transition-all {{ Request::is('booking/jadwal') || Request::is('booking/pilih-kursi') || Request::is('booking/konfirmasi') ? 'text-brand-600 bg-brand-50/80 border border-brand-100 shadow-[0_2px_8px_rgba(37,99,235,0.06)]' : 'text-slate-600 hover:text-brand-600 hover:bg-slate-50/80' }}">
                        Cari Tiket
                    </a>

                    <a href="/booking/status" class="px-4 py-2 text-xs lg:text-sm font-semibold rounded-xl transition-all {{ Request::is('booking/status') || Request::is('booking/status-detail') ? 'text-brand-600 bg-brand-50/80 border border-brand-100 shadow-[0_2px_8px_rgba(37,99,235,0.06)]' : 'text-slate-600 hover:text-brand-600 hover:bg-slate-50/80' }}">
                        Status Pemesanan
                    </a>

                    <a href="/profil" class="px-4 py-2 text-xs lg:text-sm font-semibold rounded-xl transition-all {{ Request::is('profil') ? 'text-brand-600 bg-brand-50/80 border border-brand-100 shadow-[0_2px_8px_rgba(37,99,235,0.06)]' : 'text-slate-600 hover:text-brand-600 hover:bg-slate-50/80' }}">
                        Profil
                    </a>
                </nav>
                ...
                <div class="hidden md:flex items-center space-x-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="hidden xl:flex flex-col text-left">
                            <span class="text-xs font-bold text-slate-800 leading-tight">RTM Passenger</span>
                    ...
                    <!-- Logout Button -->
                    <button class="text-sm font-semibold text-slate-500 hover:text-status-danger transition-colors focus:outline-none cursor-pointer">
                        Keluar
                    </button>
                </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden border-t border-slate-100 bg-white/95 backdrop-blur-lg transition-all duration-300 ease-in-out">
            <div class="px-3 pt-3 pb-5 space-y-2">
                <a href="/" class="block px-3 py-2.5 rounded-xl text-sm font-semibold {{ Request::is('/') ? 'text-brand-600 bg-brand-50 border-l-4 border-brand-500 shadow-xs' : 'text-slate-600 hover:text-brand-600 hover:bg-slate-50' }}">
                    Beranda
                </a>
                
                <a href="/booking/jadwal" class="block px-3 py-2.5 rounded-xl text-sm font-semibold {{ Request::is('booking/jadwal') || Request::is('booking/pilih-kursi') || Request::is('booking/konfirmasi') ? 'text-brand-600 bg-brand-50 border-l-4 border-brand-500 shadow-xs' : 'text-slate-600 hover:text-brand-600 hover:bg-slate-50' }}">
                    Cari Tiket
                </a>
                
                <a href="/booking/status" class="block px-3 py-2.5 rounded-xl text-sm font-semibold {{ Request::is('booking/status') || Request::is('booking/status-detail') ? 'text-brand-600 bg-brand-50 border-l-4 border-brand-500 shadow-xs' : 'text-slate-600 hover:text-brand-600 hover:bg-slate-50' }}">
                    Status Pemesanan
                </a>
                
                <a href="/profil" class="block px-3 py-2.5 rounded-xl text-sm font-semibold {{ Request::is('profil') ? 'text-brand-600 bg-brand-50 border-l-4 border-brand-500 shadow-xs' : 'text-slate-600 hover:text-brand-600 hover:bg-slate-50' }}">
                    Profil Saya
                </a>
                ...
                <div class="pt-4 mt-3 border-t border-slate-100 flex items-center justify-between px-3">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs font-bold text-slate-700">RTM Passenger</span>
                    </div>
                    <button class="text-xs font-bold text-status-danger hover:text-red-500 transition-colors">
                        Keluar
                    </button>
                </div>
            </div>
