                ...
                <table class="min-w-full divide-y divide-slate-100">
                    <thead class="bg-slate-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500 text-center">Aksi</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-slate-100 text-sm">
                        @forelse($pemesanans as $p)
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="px-6 py-5 font-bold text-slate-900 whitespace-nowrap">
                                ...
                                <td class="px-6 py-5 whitespace-nowrap">
                                    @if(in_array($p->status, ['Lunas', 'Dikonfirmasi']))
                                ...
                                <td class="px-6 py-5 text-center whitespace-nowrap">
                                    <a href="{{ route('penumpang.status.detail', $p->id_pemesanan) }}" class="px-3.5 py-1.5 text-xs font-bold text-slate-800 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors inline-flex items-center gap-1">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-8 text-center text-slate-500 font-semibold">
