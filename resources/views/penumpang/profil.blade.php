...
<div class="py-8 bg-slate-50 md:py-12">
    <div class="px-4 mx-auto max-w-5xl sm:px-6 lg:px-8">
        ...
        @if(session('success'))
            <div class="mb-6 p-4 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-sm font-bold flex items-center gap-2">
        ...
        <form action="{{ route('penumpang.profil.update') }}" method="POST" id="profile-form">
            @csrf
            @method('PUT')
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="nama" name="nama" required value="{{ old('nama', $penumpang->nama ?? Auth::user()->name) }}" class="block w-full pl-10 pr-4 py-3 text-sm text-slate-800 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-all">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" name="email" readonly disabled value="{{ $penumpang->email ?? Auth::user()->email }}" class="block w-full pl-10 pr-4 py-3 text-sm text-slate-800 bg-slate-100 border border-slate-200 rounded-xl cursor-not-allowed">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" id="no_hp" name="no_hp" required value="{{ old('no_hp', $penumpang->no_hp ?? '') }}" class="block w-full pl-10 pr-4 py-3 text-sm text-slate-800 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-all">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea id="alamat" name="alamat" rows="3" class="block w-full pl-10 pr-4 py-3 text-sm text-slate-800 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-all resize-none">{{ old('alamat', $penumpang->alamat ?? '') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="bg-white rounded-2xl shadow-card border border-slate-100 p-6 md:p-8 transition-all">
                        ...
                        <div class="space-y-5">
                            <!-- Input: Password Baru -->
                            <div>
                                <label for="password" class="block text-xs font-semibold uppercase tracking-wider text-slate-600 mb-2">Password Baru</label>
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none text-slate-400">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" /></svg>
                                    </span>
                                    <input type="password" id="password" name="password" placeholder="Kosongkan jika tidak ingin diubah" class="block w-full pl-10 pr-4 py-3 text-sm text-slate-800 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-all">
                                </div>
                            </div>
                        </div>
                    </div>
