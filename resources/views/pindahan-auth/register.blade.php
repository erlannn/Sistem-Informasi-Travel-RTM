        ...
        <div class="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-white relative overflow-y-auto">
            ...
            <div class="w-full max-w-md my-auto py-8">
                ...
                <form action="#" method="POST" class="space-y-4">
                    ...
                    <!-- Input: No. HP -->
                    <div>
                        <label for="phone" class="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-1.5">No. HP</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none text-slate-400">
                                <svg class="w-4.5 h-4.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            ...
                            <input type="tel" id="phone" name="phone" required placeholder="0812xxxxxxxx" 
                                class="block w-full pl-10.5 pr-4 py-2.5 text-sm text-slate-800 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all placeholder:text-slate-400 outline-none">
                        </div>
                    </div>
