        ...
        <form action="{{ route('admin.jadwal.store') }}" method="POST" class="space-y-6">
            ...
            <div id="route-info-banner" class="bg-amber-50 border border-amber-200 p-4 rounded-2xl space-y-1 text-xs">
                ...
                <div class="flex justify-between text-[11px] text-slate-600 font-medium pt-1 border-t border-amber-200/60">
                    <span>Bagi Hasil Supir: <strong id="route-driver" class="text-emerald-700">Rp 30.000</strong></span>
                    <span>Setoran Perusahaan: <strong id="route-company" class="text-blue-700">Rp 50.000</strong></span>
                </div>
            </div>
